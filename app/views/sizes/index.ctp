<div class="sizes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('inner');?></th>
			<th><?php echo $this->Paginator->sort('outer');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $size['Size']['height']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['width']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['depth']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['inner']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['outer']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['created']; ?>&nbsp;</td>
		<td><?php echo $size['Size']['modified']; ?>&nbsp;</td>
		<td class="actions">
